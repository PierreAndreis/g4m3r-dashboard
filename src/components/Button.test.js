...
describe("Button", () => {
  ...
  it("onClick is called if clicked giving button actions", () => {
  ...
  it("buttonActions - success", async () => {
    const onClick = jest.fn(buttonActions => {
