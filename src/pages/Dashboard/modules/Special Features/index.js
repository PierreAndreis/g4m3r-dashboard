...
class SpecialFeatureEditor extends Component {
  render() {
    return (
      <Query query={qGuildBasic} variables={{ guildId: this.props.match.params.guildId }}>
        {({ loading, error, data }) => {
            ...
            return (
              <React.Fragment>
                <section>
                  ...
                  <SubHeader>
                    This page shows VIP features that are available to VIP servers. To
                    become a VIP and unlock all these amazing features please become a
                    patron.
                  </SubHeader>
                </section>
                ...
                <section>
                  <a
                    href="https://patreon.com/g4m3r"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button big>Become A Patreon</Button>
                  </a>
                </section>
              </React.Fragment>
            );
                        ...
                        <Box.Body>
                          <Box.Option>
                            ...
                            <div>
                              <HelpModal
                                content={
                                  <HelpContent
                                    {...HelpText.vainglory.activityReportsChannel}
                                  />
                                }
                              />
                            </div>
                          ...
                          <Box.Option>
                            ...
                            <div>
                              <HelpModal
                                content={
                                  <HelpContent {...HelpText.vainglory.maxInactiveDays} />
                                }
                              />
                            </div>
                          </Box.Option>
